...
public class AtkKeyEvent {
    ...
    public AtkKeyEvent(KeyEvent e) {
        ...
        // ATK keycode should be the raw X11 hardware scancode, which Java does not expose.
        // GNOMEKeyMapping keys use GDK keysyms (0xFF00+), safely above X11 hardware range.
        // For other keys, Java's VK_* codes (e.g. VK_Q=81) collide with X11 hardware
        // keycodes (e.g. keycode 81 = KP_Page_Up), causing Orca to falsely match grabbed keys.
        // Use 0 for unmapped keys so Orca falls back to keyval-based matching only.
