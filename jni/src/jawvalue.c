...
static gboolean jaw_value_convert_double_to_gdouble(JNIEnv *jniEnv,
    ...
    *result = (gdouble)(*jniEnv)->CallDoubleMethod(
        jniEnv, jdoubleObj, cachedValueDoubleValueMethod);
    return TRUE;
}
...
static gboolean jaw_value_init_jni_cache(JNIEnv *jniEnv) {
    ...
    jclass localByte = NULL;
    jclass localDouble = NULL;
    jclass localFloat = NULL;
    jclass localInteger = NULL;
    jclass localLong = NULL;
    jclass localShort = NULL;
